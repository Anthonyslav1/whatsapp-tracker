---
name: autonomous-version-control
description: >
  This skill executes stage-by-stage Git version control. It analyzes code diffs,
  stages files in logical atomic units, and generates highly structured,
  industry-standard commit messages based on the Conventional Commits specification.
  Triggers for any work involving git, commits, version control, or staging changes.
---
...
### Example 1: Committing a New Feature (Ravdesk Context)
